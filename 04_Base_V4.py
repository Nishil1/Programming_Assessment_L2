...
def triangle(var_base, var_height, first_side, second_side, third_side):
    return (f"Area: {0.5 * var_base * var_height}, "
            f"Perimeter: {first_side + second_side + third_side}")
...
while number_of_calculations == "" or calculations_done < number_of_calculations:
    ...
    if select_shape == "circle":
        ...
        first_side = num_check("Side 1: ")
        second_side = num_check("Side 2: ")
        third_side = num_check("Side 3: ")
        print(triangle(base, height, first_side, second_side, third_side))
